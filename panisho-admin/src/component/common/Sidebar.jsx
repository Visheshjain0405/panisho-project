...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`bg-primary text-secondary w-64 space-y-6 py-7 px-2 fixed inset-y-0 left-0 transform ${
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `block px-4 py-2 rounded-md ${
                isActive ? 'bg-secondary text-primary' : 'text-secondary hover:bg-gray-800'
              }`
            }
